...
const ArticlesPagination = ({ nPages, currentPage, setCurrentPage }) => {
    ...
    return (
        <>
            <div className="pagination d-flex flex-wrap items-center justify-center gap-3 mt-4 marginb-md1">
                <button onClick={prevPage} className="paginateBtn">
                    <FeatherIcon icon="arrow-right" style={{ width: "13px", color: "white" }} />
                </button>
                ...
                <button onClick={nextPage} className="paginateBtn">
                    <FeatherIcon icon="arrow-left" style={{ width: "13px", color: "white" }} />
                </button>
            </div>
        </>
    );
