          ...
          <div className="modal-body centerModalBody">
            <form dir="rtl" onSubmit={addArticle}>
              ...
              <div className="row">
                ...
                <div className="form-group col d-flex gap-2 align-items-center justify-center gap-3">
                  <p className="font-12 mt-1 text-secondary">نمایش در اسلاید <span className="text-danger">*</span></p>
                  <input
                    type="checkbox"
                    hidden="hidden"
                    id="showInSlider"
